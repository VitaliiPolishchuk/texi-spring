    ...
    <body>
      ...
      <div class="map-container container z-depth-1">
        <div class="row">
          <div class="col s6">
            <div id="title">
              <spring:message code="order.greetings"/>
            </div>
            <div class="row">
              <form method="POST" class="col s6" action="/order" id="mapForm">
                <div class="row">
                  <div class="input-field col s6">
                    <input name="<%=ParamAttrConstant.ORIGIN%>" placeholder="<spring:message code="origin"/>" id="origin" type="text" class="validate">
                    <label for="origin">
                ...
                <div class="row">
                  <div class="input-field col s6">
                    <input name="<%=ParamAttrConstant.DESTINATION%>" placeholder="<spring:message code="destination"/>" id="destination" type="text" class="validate">
                    <label class="active" for="destination">
                      <spring:message code="destination"/>
                    </label>
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col s12">
                    ...
                    <label class="active" for="discount">
                ...
                <div class="row">
                  <div class="input-field col s5 m5">
                    <button class="z-depth-2 waves-effect waves-light btn" type="submit" name="action">
                      <spring:message code="book_now.button"/>
                      <i class="material-icons left">drive_eta
                      </i>
                    </button>
                  </div>
                </div>
